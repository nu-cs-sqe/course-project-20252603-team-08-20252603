...
|              | State of the System                                                                                 | Expected output                                                                                                                                                                                                                                                  | Implemented?       |
|--------------|-----------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------|
| Test Case 40 | After startGame(2), current player has enough gem tokens to buy level 1 card at index 0             | Returns ActionResult (isSuccess=true), card moves from face-up cards to current player's development cards, player tokens decrease, token bank increases by spent tokens, prestige increases by card points, market refills, current player advances to player 1 | :white_check_mark: |
| Test Case 41 | After startGame(2), current player buys level 1 card using one matching bonus to reduce cost        | Returns ActionResult (isSuccess=true), player spends only remaining cost after bonus, token bank increases only by spent tokens, bought card is added to development cards, current player advances                                                              | :white_check_mark: |
| Test Case 42 | After startGame(2), current player buys level 1 card using GOLD to cover missing gem token          | Returns ActionResult (isSuccess=true), player spends available gem tokens and GOLD, token bank receives those tokens, bought card is added to development cards, current player advances                                                                         | :white_check_mark: |
...
| Test Case 45 | After startGame(2), current player buys invalid level 4 card at index 0                             | Returns ActionResult (isSuccess=false) with invalid buy card message, player tokens unchanged, token bank unchanged, development cards unchanged, current player unchanged                                                                                       | :white_check_mark: |
