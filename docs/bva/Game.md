...
| Test Case 52 | After startGame(2), player 0 has one reserved card costing 1 RUBY but no matching tokens, then player 0 buys reserved card at index 0                                                                                | Returns ActionResult (isSuccess=false) with invalid buy card message, player tokens unchanged, token bank unchanged, reserved cards unchanged, development cards unchanged, prestige unchanged, current player unchanged                               | :x:          |
