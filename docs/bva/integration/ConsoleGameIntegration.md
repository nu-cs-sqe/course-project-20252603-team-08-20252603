...
|                  | State of the System                                                                                    | Expected output                                                                                                                                                                                                 | Implemented? |
|------------------|--------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|
| Integration TC 4 | New `ConsoleGame` with stdin lines: `en`, `2`, `not-a-command`, `quit`; stdout captured              | Console output contains `ui.game_started` (US locale), `ui.unknown_action` (US locale), and `ui.goodbye` (US locale); game table is printed before the unknown action prompt and before quit                     | :white_check_mark: |
