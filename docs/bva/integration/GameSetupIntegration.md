...
|                    | State of the System                                      | Expected output                                                                                                                                                                                                                         | Implemented? |
|--------------------|----------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|
| Integration TC 2   | New `Game`, `playerCount = 1`, `locale = US`             | `ActionResult.isSuccess() == false`, message == `error.invalid_player_count` for US locale, `phase == SETUP`, `getTokenBank() == null`, `getFaceUpCards(1) == null`, `getDeck(1) == null`, `getRevealedNobles() == null`              | :x:          |
